		...
		return (
			<div>
				<h2>
					Path
					<Help>
						If you want to call an existing binary command, choose 'binary' type and enter its path. The path can contain arguments. If path is relative (not starting with a /), it will be relative the the processmanager.monitor.path configuration directive.
			...
			<div>
				...
				<div className="formdiv">
					<div>
						...
						<Select name="parametersmode" value={task.parametersmode} values={[{name: 'Command line', value: 'CMDLINE'}, {name: 'Environment variables', value: 'ENV'}]} filter={false} onChange={this.props.onChange} />
					</div>
				</div>
